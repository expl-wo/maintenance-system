<template>
  <el-dialog draggable :close-on-click-modal="false" :title="'角色分配'" width="800"
  v-if="dialogFormVisible" v-model="dialogFormVisible" class="roleDialog">
    <el-form ref="formRef" label-width="160px" :rules="rules" :model="model">
      <el-form-item prop="code" label="员工姓名">
        <el-input v-model="model.ownerName"></el-input>
      </el-form-item>
...
import {insertUserRoleInfo} from "@/sys/api/role";
  ...
  methods: {
    ...
    saveData(){
      this.$refs.formRef.validate(valid=>{
        ...
        insertUserRoleInfo(this.model).then(response=>{
