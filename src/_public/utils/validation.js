...
var spellNumberChar = /^[a-zA-Z0-9]*$/;
validation.checkSpellNumberChar = function (str) {
  return spellNumberChar.exec(str);
};
...
//验证 资产编码  数字,字母,下划线
var patrn = /^([a-zA-Z0-9-]){1,60}$/;
// var patrn = /^([a-zA-Z0-9-]){1,100}$/;
validation.checkAssetsCode = function (str) {
  return patrn.exec(str);
};
...
//验证国内手机号
var REG_PHONE = /^(0|86|17951)?(1(2|3|4|5|6|7|8|9))[0-9]{9}$/;
...
validation.checkNonnegative = function (str) {
