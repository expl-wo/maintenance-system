  ...
  <div class="app-container app-containerC">
    <div class="filter-container searchCon">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline demo-form-zdy">
        <el-form-item label="主材类型名称" >
          <el-input v-model="listQuery.auxiliaryTypeName" placeholder="输入主材类型名称" style="width: 170px;" class="filter-item"
                    clearable />
        </el-form-item>
        <el-form-item >
    ...
    <el-dialog v-dialogDrag  appendToBody :title="listItemQuery.id? '编辑': '新增'"
      ...
      <el-form :model="listItemQuery" class="element-list" ref="form" label-width="160px">
        <el-row>
          <el-col :span="24">
            <el-form-item label=" 主材类型名称:" prop="craftsName" >
              <el-input v-model="listItemQuery.mainTypeName" placeholder="请输入主材类型名称" style="width: 350px;"
                        class="filter-item" />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handEdit(row){
      ...
      this.listItemQuery.mainTypeName = row.mainTypeName
    ...
    saveItemData() {
      ...
      let params = {
        ...
        mainTypeName: this.listItemQuery.mainTypeName,
