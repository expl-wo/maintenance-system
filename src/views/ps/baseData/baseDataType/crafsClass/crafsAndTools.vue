<template>
  ...
  <div class="app-container app-containerC">
    ...
    <crafs-and-tools-add-or-update-dialog @refresh="onBtnQuery" ref="crafsAndToolsAddOrUpdateDialogRef"></crafs-and-tools-add-or-update-dialog>
  </div>
</template>
...
// 辅材类型查询
import {deleteTools,getCrafsAndTools} from '@/api/eqpLedger'
import Pagination from "@/components/Pagination/index";
import Constants from "@/utils/constants";

import crafsAndToolsAddOrUpdateDialog from "@/views/ps/baseData/baseDataType/crafsClass/crafsAndToolsAddOrUpdateDialog";

export default {
  components: {crafsAndToolsAddOrUpdateDialog,Pagination },
  data() {
    return {
      total: 0, // 角色列表表格总条数
      listQuery: { // 查询条件
  ...
  methods: {
    ...
    handleAdd(){
      this.$refs.crafsAndToolsAddOrUpdateDialogRef.init();
    },
    handleEdit(rowData){
      this.$refs.crafsAndToolsAddOrUpdateDialogRef.init(rowData);
    },
