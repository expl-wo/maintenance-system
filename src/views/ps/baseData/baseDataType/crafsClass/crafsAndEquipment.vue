    ...
    <div class="filter-container searchCon">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline demo-form-zdy">
        <el-form-item label="设备类型名称" >
          <el-input v-model="listQuery.equipmentTypeName" placeholder="输入设备类型名称" style="width: 170px;" class="filter-item"
                    clearable />
        </el-form-item>
        <el-form-item >
...
export default {
  ...
  data() {
    return {
      ...
      listQuery: { // 查询条件
        ...
        equipmentTypeName: null, // 模糊匹配，设备分类名称
        crafsName:null,
        crafsId:'',
        id:''
      },
  ...
  methods: {
    ...
    onQuery() {
      this.tableData = []
      getCrafsAndEquipment(this.listQuery).then(response => {
