  ...
  <div class="app-container app-containerC">
    <div class="filter-container searchCon hasLegend">
      ...
      >
        ...
        <el-button icon="Search" size="small" v-if="$isAuth('0407dismantlePlan.search')" @click="queryTableDataParam">查询</el-button>
        <el-button type="primary" icon="Coordinate" size="small" v-if="$isAuth('0407dismantlePlan.approval')" @click="handleApply">提交审批</el-button>
        <el-button type="danger" icon="Delete" size="small"  v-if="$isAuth('0407dismantlePlan.delete')" @click="handleDelete">取消计划</el-button>
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="70">
        <template v-slot="scope">
          <el-button size="small" type="primary" v-if="scope.row.id && $isAuth('0407dismantlePlan.editTime')" @click="editPlan(scope.row)">修改</el-button>
        </template>
      </el-table-column>
