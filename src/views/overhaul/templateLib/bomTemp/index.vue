      ...
      <div class="search-wrapper">
        <el-form :inline="true">
          ...
          <el-form-item>
            ...
            <el-button  type="primary"  @click="openModal(null, null, 'add')"><el-icon class="el-icon--left"><Plus /></el-icon
              >新增</el-button>
        ...
        >
          ...
          <el-table-column label="操作" width="240">
            <template  #default="scope">
              ...
              ></el-button>
                <el-button type="danger"  title="删除" @click="singleDel(scope.$index, scope.row)"><el-icon><Delete /></el-icon
              ></el-button>
              </el-button-group>
            </template>
          </el-table-column>
