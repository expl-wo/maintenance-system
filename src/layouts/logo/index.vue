<template>
  ...
  >
    <img v-if="showLogo && !state.isCollapse" class="logo-img" :src="require('@/assets/logo.png')" />
    <img v-if="showLogo && state.isCollapse" class="logo-img mini" :src="require('@/assets/logo_mini.png')" />
  </div>
</template>
